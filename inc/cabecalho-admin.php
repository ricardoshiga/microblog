...
/* Verificar se o link SAIR foi acionado, e se foi, deslogar o usuario */
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                ...
                <!-- Programação de logout
            1) Criar um parâmetro de URL no href.
        Neste exemplo, criamos com o nome de ?logout (sair)-->
